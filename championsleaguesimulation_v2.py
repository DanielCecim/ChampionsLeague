...
PLAYER_NAMES = [
    ...
    "Alejandro Balde", "Ronald Araújo", "Pau Cubarsí", "Jules Koundé",
    "Marc-André ter Stegen",
    # Real Madrid 
    "Kylian Mbappé", "Vinícius Júnior", "Rodrygo",
    "Jude Bellingham", "Federico Valverde", "Aurélien Tchouaméni",
    "Éder Militão", "Antonio Rüdiger", "Dani Carvajal", "Trent Alexander-Arnold",
    "Thibaut Courtois"
]
...
#Stadium class, contains multiple thread event flags to control flow.
class Stadium:
    def __init__(self):
...
class Fan(threading.Thread):
    ...
    def run(self):
            ...
            if random.random() < PROB_QUEUE_VISIT:
                # pick a random shop among all available shops
